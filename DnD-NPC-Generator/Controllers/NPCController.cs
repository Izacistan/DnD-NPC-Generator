...
namespace DnD_NPC_Generator.Controllers
{
    public class NPCController : Controller
    {
        ...
        public IActionResult Generate(string classChoice, string statChoice)
        {
            ...
            ViewBag.Classes = this.legion.GetAllClasses();
            ViewBag.Races = this.legion.GetAllRaces();
            service.GenerateNPC(ref npc, ViewBag.Classes, ViewBag.Races, classChoice, statChoice);
        ...
        public IActionResult Edit(NPC npc)
        {
            ...
            if ((npc.NPCClassId == 1 || npc.NPCRaceId == 1) && !npc.IsAutoGenerated)
            {
            ...
            {
                if (npc.IsAutoGenerated)
                {
                    service.GenerateNPC(ref npc, this.legion.GetAllClasses(), this.legion.GetAllRaces(), "Random", npc.StatChoice);
                }
